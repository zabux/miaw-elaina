...
export declare function loadTfModel(modelPath: string, modelType?: ModelType): Promise<tf.LayersModel | tf.GraphModel<string | import("@tensorflow/tfjs-core/dist/io/types").IOHandler>>;
