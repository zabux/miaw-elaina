...
export async function* warmup(modelPackage, sizes) {
    ...
    for (const size of sizes) {
        ...
        let dummyTensor = tf.zeros([1, height, width, 3,]);
        yield [dummyTensor,];
        const fns = [
...
export const cancellableWarmup = async (modelPackage, sizes, { signal = undefined, awaitNextFrame = false, } = {}, internalArgs) => {
