...
let handler = async (m, { conn, args, usedPrefix, command }) => {
	...
	const styles = ["anime", "manhwa_female", "manhwa_male", "cg", "princess"];
...
handler.help = ["drawme", "animeface", "differentme"];
handler.tags = ["ai", "anime", "premium"];
handler.command = ["drawme", "animeface", "jadianime", "differentme"];
