...
❃ *Title Romaji:* ${json.result.title.romaji} ${
		json.result.title.english
			? `
...
❃ *Format:* ${json.result.format} ${
		json.result.chapters == "null"
			? `
❃ *Chapters:* ${json.result.chapters}`
			: ""
	} ${
