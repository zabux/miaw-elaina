...
${
	user.bibitpisang < 100
		? `
${rpg.emoticon("bibitpisang")} BibitPisang: ${pisang}`
		: ""
} ${
		user.bibitanggur < 100
			? `
${rpg.emoticon("bibitanggur")} BibitAnggur: ${anggur}`
			: ""
	} ${
		user.bibitmangga < 100
			? `
${rpg.emoticon("bibitmangga")} BibitMangga: ${mangga}`
			: ""
	} ${
		user.bibitjeruk < 100
			? `
${rpg.emoticon("bibitjeruk")} BibitJeruk: ${jeruk}`
			: ""
	} ${
		user.bibitapel < 100
			? `
